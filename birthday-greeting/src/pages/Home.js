...
P.S. (Роман)`;
  ...
  useEffect(() => {
    ...
    if (isVisible) {
      let i = 0;
      const greeting2 = 'Вітаю тебе з днем народження!!!Доця ти в мене найкраща.Розвивайся,вчися,шукай нові напрямки,став високі цілі і ти з усім впораєшся.Радій життю та насолоджуйся ним в повному обсязі.Я в тебе вірю Параскев'я)))';
      interval = setInterval(() => {
